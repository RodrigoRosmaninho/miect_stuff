...
class Bitmap {
    ...
    public void exportAsRAW() throws IOException {
        FileOutputStream fos = new FileOutputStream("../P-III/src/aula7/ex2/Figura.raw");
    ...
    public void exportAsBMP(String name) throws  IOException {
        FileOutputStream fos = new FileOutputStream("../P-III/src/aula7/ex2/" + name + ".bmp");
        DataOutputStream dos = new DataOutputStream(fos);
