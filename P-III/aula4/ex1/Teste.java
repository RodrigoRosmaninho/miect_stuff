...
public class Teste {
	public static void main(String[] args) throws DateValidationException {
		...
		if (dis.alunoInscrito(est3.nMec())) System.out.println("\n" + est3 + " \n\t-> ESTÁ inscrito na Disciplina");
		...
		if (!dis.addAluno(bls3)) System.out.println(bls3.nMec() + ", " + bls3.nome() + " já está inscrito nesta disciplina!");
		if (dis.delAluno(bls2.nMec())) System.out.println(bls2.nome() + " Removido!");
		System.out.println("\nNo de Alunos Inscritos: " + dis.numAlunos());
		...
		for (Estudante e : dis.getAlunos("Bolseiro")) System.out.println(e);
	}
}
