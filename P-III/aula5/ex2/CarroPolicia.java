...
public class CarroPolicia extends Automovel implements Policia{
	...
	public CarroPolicia(int ano, String cor, double velMax, int potencia, double consumo, double combustivel, double cilindrada, String matricula, Tipo tipo, String ID) {
