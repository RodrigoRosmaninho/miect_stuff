...
public class rev1Parser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitProgram(this);
	...
	public static class PrintStringContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitPrintString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AssignIDContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitAssignID(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ConcatStringContext extends StringContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitConcatString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class InputStringContext extends StringContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitInputString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IdStringContext extends StringContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitIdString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ReplaceStringContext extends StringContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitReplaceString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LiteralContext extends StringContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof rev1Visitor ) return ((rev1Visitor<? extends T>)visitor).visitLiteral(this);
			else return visitor.visitChildren(this);
		}
	}
