...
public class prepParser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitProgram(this);
	...
	public static class StatAssignContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitStatAssign(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StatShowContext extends StatContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitStatShow(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ValueVectorContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueVector(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueSignContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueSign(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueProdContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueProd(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueNumContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueNum(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueIdContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueId(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueMultContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueMult(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueParContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValuePar(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueSumSubContext extends ValueContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitValueSumSub(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VectorContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof prepVisitor ) return ((prepVisitor<? extends T>)visitor).visitVector(this);
			else return visitor.visitChildren(this);
		}
	}
