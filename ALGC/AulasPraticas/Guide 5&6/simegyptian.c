/*******************************************************************************
 ...
 Programa gr�fico de simula��o da funcionalidade do TDA Egyptian Fraction
...
#include "fraction.h"  /* Ficheiro de interface do tipo fra��o */
#include "egyptianfraction.h"  /* Ficheiro de interface do tipo fra��o eg�pcia - vers�o est�tica */
